        ...
        <div className="p-10 md:p-14">
          <form ref={formRef} action={formAction} className="space-y-8">
            ...
            <button
              type="submit"
              disabled={pending}
              className={`w-full py-4 px-6 flex justify-center items-center rounded-2xl text-white font-medium text-lg transition-all shadow-lg overflow-hidden relative group ${
                pending 
          ...
          <div
            className={`transition-all duration-700 ease-in-out ${
              state.summary && !pending ? 'opacity-100 max-h-[2000px] mt-10' : 'opacity-0 max-h-0 overflow-hidden'
            }`}
          >
            <div className="relative p-8 rounded-2xl bg-neutral-900/80 border border-indigo-500/20 backdrop-blur-md shadow-2xl">
              ...
              <div className="prose prose-invert prose-indigo max-w-none prose-p:leading-relaxed prose-headings:text-indigo-100 prose-a:text-indigo-400">
                ...
                <div className="whitespace-pre-wrap text-neutral-300 leading-relaxed font-serif text-lg">
                  {state.summary}
                </div>
              </div>
            </div>
